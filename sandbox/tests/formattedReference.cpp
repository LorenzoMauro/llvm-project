...
public:
    ...
    Pair(
        const Pair<Pair<V, W>, Pair<T, U>> & p) :
        mfirst(p.mfirst),
        msecond(p.msecond)
    {}
        ...
        float c)
    {
        ...
        bool someSuperLongVariableAssignment = superLongConditionNameYeahA &&
                                               superLongConditionNameYeahB &&
                                               superLongConditionNameYeahC &&
                                               superLongConditionNameYeahD &&
                                               superLongConditionNameYeahE;
